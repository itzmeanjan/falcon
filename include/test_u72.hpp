...
u72_ops()
{
  ...
  const uint8_t bytes0[9] = { 254, 255, 255, 255, 255, 255, 255, 255, 255 };
  const char* str2 = "1";
  const uint8_t bytes1[9] = { 254, 0, 0, 0, 0, 0, 0, 0, 0 };

  const u72::u72 v0 = u72::from_decimal(str0, 22);
  const u72::u72 v1 = u72::from_decimal(str1, 22);
  const u72::u72 v2 = u72::from_decimal(bytes0);
  const u72::u72 v3 = u72::from_decimal(str2, 1);
  const u72::u72 v4 = u72::from_decimal(bytes1);
